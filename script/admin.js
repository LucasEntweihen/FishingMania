/* ==========================================================================
   PAINEL DE MESTRE (GOD MODE / ADMIN CHEATS) - BLINDADO PELO FIREBASE
   ...
   function initAdminPanel() {
       ...
       style.innerHTML = `
           ...
           .admin-btn {
               ...
               border: 1px solid #ef4444; border-radius: 8px; padding: 10px; margin-bottom: 10px;
               font-weight: bold; cursor: pointer; transition: 0.2s; font-family: 'Poppins';
           }
           ...
           <div class="admin-content custom-scrollbar">
               ...
               <div class="admin-grid">
                   <div class="admin-box">
                       ...
                       <button class="admin-btn gold" onclick="adminAddCoins(1000000)">+ 1.000.000 Cat Coins</button>
                       <button class="admin-btn gold" onclick="adminAddCoins(1000000000)">+ 1 Bilhão (Infinito)</button>
                       <button class="admin-btn green" onclick="adminUnlockFeatures()">Desbloquear Sushi/Features</button>
                   </div>
                   <div class="admin-box">
                       <h3>📦 Estoque Absoluto</h3>
                       <button class="admin-btn" onclick="adminAddAllMaterials(1000)">+ 1.000 de TODOS os Materiais</button>
                       <button class="admin-btn" onclick="adminAddAllBoosts(500)">+ 500 de TODOS os Catalisadores</button>
                       <button class="admin-btn" onclick="adminAddAllScrap(100)">+ 100 de CADA Sucata (Lixo)</button>
                   </div>
                   <div class="admin-box">
                       <h3>🐟 Aquário Mestre</h3>
                       <button class="admin-btn blue" onclick="adminAddAllFishes(10, false)">+ 10 de CADA Peixe (Normal)</button>
                       <button class="admin-btn blue" onclick="adminAddAllFishes(5, true)">+ 5 de CADA Peixe (Troféu 67cm)</button>
                       <button class="admin-btn blue" onclick="adminAddAllOrbs(10)">+ 10 Orbes de Cada Ritual</button>
                   </div>
                   <div class="admin-box">
                       <h3>🌪️ Controle Climático</h3>
                       <button class="admin-btn" onclick="adminForceEvent('tempestade')">Forçar: Tempestade ⛈️</button>
                       <button class="admin-btn gold" onclick="adminForceEvent('ouro')">Forçar: Maré Dourada ✨</button>
                       <button class="admin-btn" onclick="adminForceEvent('frenesi')">Forçar: Frenesi 🦈</button>
                       <button class="admin-btn" style="border-color:#a855f7;" onmouseover="this.style.background='#a855f7'" onmouseout="this.style.background='#27272a'" onclick="adminForceEvent('misticismo')">Forçar: Nevoeiro Místico 🔮</button>
                       <button class="admin-btn" style="border-color:#7f1d1d;" onmouseover="this.style.background='#7f1d1d'" onmouseout="this.style.background='#27272a'" onclick="adminForceEvent('mar_bestas')">Forçar: Mar das Bestas 🐙</button>
                       <button class="admin-btn green" onclick="adminStopEvent()">☀️ Parar Evento Atual</button>
                   </div>
               </div>
           </div>
       `;
   ...
   window.adminStopEvent = function() { if(window.stopEvent) window.stopEvent(); }
